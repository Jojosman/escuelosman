...
if ($rpta){
    ...
    echo "CALL sp_agregar_alumno('".$_POST['nombre']."','".$_POST['paterno']."','".$_POST['materno']."','".$_POST['correo']."','".$_POST['fec_nac']."','".$_POST['matricula']."','".$_POST['curp']."','".$_POST['tel_celular']."','".$_POST['tel_casa']."')";
}
