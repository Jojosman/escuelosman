...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-04-2021 a las 01:21:08
...
CREATE PROCEDURE `sp_agregar_carrera` (IN `_NOMBRE_CARRERA` VARCHAR(255), IN `_ABRIEVATURA` VARCHAR(255))  BEGIN
...
CREATE PROCEDURE `sp_select_carreras` ()  BEGIN
    SELECT
        id_carrera,
        nombre,
        abreviatura
...
CREATE PROCEDURE `sp_select_carrera_id` (IN `_ID_CARRERA` INT(255))  BEGIN
    SELECT 
        id_carrera,
        nombre,
        abreviatura
...
CREATE PROCEDURE `sp_update_carrera` (IN `_ID_CARRERA` INT(255), IN `_NOMBRE` VARCHAR(255), IN `_ABREVIATURA` VARCHAR(255))  BEGIN
	UPDATE carreras
	SET nombre = _NOMBRE,
...
(5, 'Mantenimiento industrial', 'MAI'),
(6, 'Mantenimiento Homosexual', 'HoMo');
...
--
ALTER TABLE `carreras`
  MODIFY `id_carrera` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `materias`
  MODIFY `id_materia` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
