...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-04-2021 a las 18:56:59
...
(1, 'TECNOLOGÍAS DE LA INFORMACIÓN AREA DESARROLLO DE SOFTWARE MULTIPLATAFORMA', 'TIADSM'),
(2, 'Mantenimiento Area Petroleo', 'MAP');
...
--
ALTER TABLE `carreras`
  MODIFY `id_carrera` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `materias`
  MODIFY `id_materia` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
